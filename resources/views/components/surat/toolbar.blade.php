<div class="flex justify-between items-center flex-wrap-reverse gap-4 p-4">
    <div class="flex items-center w-full sm:w-auto">
        <div class="ltr:mr-4 rtl:ml-4">
            <input type="checkbox" class="form-checkbox" :checked="checkAllCheckbox" :value="checkAllCheckbox"
        ...
        <template x-if="selectedTab != 'trash'">
            <ul class="flex grow items-center sm:flex-none gap-4 ltr:sm:mr-4 rtl:sm:ml-4">
                ...
                <li>
                    <div x-data="dropdown" @click.outside="open = false" x-tooltip="Group" data-placement="top"
                        role="tooltip" class="dropdown">
                ...
                <li>
                    <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                        <button type="button" class=" hover:text-primary flex items-center" @click="toggle">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 rotate-90 opacity-70">
                        ...
                        <ul @click="toggle" x-cloak x-show="open" x-transition x-transition.duration.300ms
        ...
        <div class="flex items-center ltr:mr-4 rtl:ml-4">
            ...
            <div class="relative group">
                <input type="text" placeholder="Search Mail" class="form-input ltr:pr-8 rtl:pl-8 peer"
                    x-model="searchText" @keyup="searchMails" />
                <div
